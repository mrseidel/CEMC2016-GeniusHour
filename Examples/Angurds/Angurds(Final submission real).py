...
icon = pygame.image.load("WarriorDown.png").convert_alpha()        
...
class Map():
    ...
    def mapScrolling(self, xheroPos, yheroPos):
        '''
        :type xheroPos: Hero x position int
        :type yheroPos: Hero y position int
...
class Hero():
    ...
    def takeDamage(self, damageNumber, xlocation, ylocation, damageRange):
        '''
        :type damageNumber: random int value
        :type xlocation: location x int
        :type ylocation: location y int
        :type damageRange: distance int for hero
    ...
    def checkEdges(self, exitingMap, exitDirection):
        '''
        :type exitingMap: boolean determining hero exiting map
        :rtype exitingMap: returns a true or false int
        :type exitDirection: int value to determine which side of map hero exits
        :rtype exitDirection: returns the side value
...
class Goblins():
    ...
    def __init__(self, xstartingPosition, ystartingPosition, speed, startingHealth):
        '''
        :type xstartingPosition: int for goblin starting position x
        :type ystartingPosition: int for goblin startign position y
        :type speed: int for goblin speed
        :type startingHealth: int for goblin life
        Default constructor
        '''
    ...
    def takeDamage(self, damageNumber, xlocation, ylocation, damageRange):
        ...
        :type xlocation: location x int
        :type ylocation: location y int
        :type damageRange: distance int for goblin
        Function called by other classes to deal damage to the hero
        '''
    ...
    def aggressive(self, xheroPos, yheroPos):
        '''
        :type xheroPos: int for hero's x position
        :type yheroPos: int for hero's y position
    ...
    def checkCollide(self, xheroPos, yheroPos, heroDirection, xheroSpeed, yheroSpeed):
        '''
        :type heroDirection: int for hero direction facing to load sprites
        :type xheroSpeed: int used to move hero x-wise
        :type yheroSpeed: int used to move hero y-wise
        :type xheroPos: int for hero's x position
        :type yheroPos: int for hero's y position
