...
<title>eSportLounge Home Page</title>
<!-- TemplateEndEditable -->
...
<div class="container">
  <div class="header"><!-- end .header --><a href="www.esportlounge.com/index.php"><img src="../images/test.png" alt="eSportLounge Logo" width="390" height="128" border="0" /></a></div>
  <div class="sidebar1">
    <ul class="nav">
